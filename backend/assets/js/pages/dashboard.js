...
$(function() {    
    ...
    // Initialize chart
    sparkline("#new-visitors", "line", 30, 35, "basis", 750, 2000, "white");
    sparkline("#new-sessions", "line", 30, 35, "basis", 750, 2000, "white");
    sparkline("#total-online", "line", 30, 35, "basis", 750, 2000, "white");
    ...
    // Initialize chart
    progressMeter("#today-progress", 20, 20, '#165395');
    progressMeter("#yesterday-progress", 20, 20, '#165395');
    ...
    // Initialize charts
    generateBarChart("#hours-available-bars", 24, 40, true, "elastic", 1200, 50, "white", "hours");
    generateBarChart("#goal-bars", 24, 40, true, "elastic", 1200, 50, "white", "goal");
    ...
    // Initialize charts
    progressCounter('#hours-available-progress', 38, 2, "white", 0.68, "icon-watch text-pink-400", 'Hours available', '64% average')
    progressCounter('#goal-progress', 38, 2, "white", 0.82, "icon-trophy3 text-indigo-400", 'Productivity goal', '87% average')
    ...
    function progressCounter(element, radius, border, color, end, iconClass, textTitle, textAverage) {
        ...
        d3.select(element)
            .append("i")
                ...
                .attr('style', 'top: ' + ((boxSize - iconSize) / 2) + 'px','color:white');
